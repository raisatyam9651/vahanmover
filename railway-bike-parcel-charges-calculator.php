    ...
    <script type="application/ld+json">
{
    ...
    "@graph": [
        {
            "@type": "WebPage",
            "name": "Railway Bike Parcel Charges Calculator | Indian Railways Bike Transport Rate",
            "url": "https://vahanmover.com/railway-bike-parcel-charges-calculator.php",
            "description": "Calculate approximate railway bike parcel charges for 2024. Get instant estimates for bike transport by train including packing and insurance cost."
        },
        {
            "@type": "LocalBusiness",
            "name": "Vahan Mover",
        ...
        },
        {
            ...
            "mainEntity": [
                {
                    "@type": "Question",
                    "name": "Is packing mandatory for railway bike transport?",
                    "acceptedAnswer": {
                        "@type": "Answer",
