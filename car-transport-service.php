...
<body>
        ...
        <div class="container" style="display: grid; grid-template-columns: 1.2fr 1fr; gap: 50px; align-items: center;">
            ...
            <div class="hero-content">
                <div
                    ...
                    <i class="fa-solid fa-car"></i> Vehicle Relocation Experts
                </div>
                <h1 style="font-size: 3.5rem; line-height: 1.1; margin-bottom: 24px; font-weight: 800;">
                    Car Transport Service in <span
                ...
                <p
                    ...
                    When you need professional <strong>auto transportation in India</strong>, we provide secure and
                    reliable solutions for moving your vehicle. Whether it's a hatchback, sedan, SUV, or luxury car, our
                    <strong>car shifting service</strong> ensures complete safety with <strong>enclosed car
                        carriers</strong> and door-to-door delivery. We handle all aspects of <strong>vehicle
                        relocation</strong>, including insurance, documentation, and real-time tracking for a
        ...
        <div class="container">
            <div style="text-align: center; margin-bottom: 60px;">
                ...
                <p style="color: var(--color-text-dim); font-size: 1.1rem; max-width: 700px; margin: 0 auto;">We provide
                    premium car moving services with specialized carriers and professional handling.</p>
            </div>
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 30px;">
                ...
                <div class="glass-card floating" style="padding: 35px; text-align: center; animation-delay: 1s;">
                    ...
                    <p style="color: var(--color-text-dim); line-height: 1.6;">Comprehensive insurance coverage for your
                        vehicle against any transit risks.</p>
                </div>
                ...
                <div class="glass-card floating" style="padding: 35px; text-align: center; animation-delay: 1.5s;">
                    ...
                    <p style="color: var(--color-text-dim); line-height: 1.6;">Nationwide car shipping across all
        ...
        <div class="container">
            <div style="text-align: center; margin-bottom: 60px;">
                ...
                <p style="color: var(--color-text-dim); font-size: 1.1rem; max-width: 700px; margin: 0 auto;">A
                    systematic approach to ensure safe auto transportation from pickup to delivery.</p>
            </div>
            ...
            <div style="max-width: 800px; margin: 0 auto;">
                ...
                <div class="glass-card floating"
                    ...
                    <div>
                        ...
                        <p style="color: var(--color-text-dim); line-height: 1.6;">We conduct a detailed
                            inspection of your car and complete all necessary documentation/condition report before
                            pickup.</p>
                    </div>
                </div>
                ...
                <div class="glass-card floating-delayed"
                    ...
                    <div>
                        ...
                        <p style="color: var(--color-text-dim); line-height: 1.6;">Your vehicle is carefully loaded onto
                            our specialized car carriers (open or enclosed) using hydraulic ramps.</p>
                    </div>
                </div>
                ...
                <div class="glass-card floating"
                    ...
                    <div>
                        ...
                        <p style="color: var(--color-text-dim); line-height: 1.6;">Your car is transported securely
                            with GPS tracking enabled, allowing you to monitor its progress.</p>
                    </div>
                </div>

                <!-- Step 4 -->
                <div class="glass-card floating-delayed"
                    style="padding: 30px; display: flex; gap: 25px; align-items: start; animation-delay: 0.5s;">
                    <div
                    ...
                    <div>
                        ...
                        <p style="color: var(--color-text-dim); line-height: 1.6;">We deliver your car at your
                            destination, followed by a final inspection and sign-off.</p>
                    </div>
                </div>
        ...
        <div class="container">
            <div style="text-align: center; margin-bottom: 60px;">
                ...
                <p style="color: var(--color-text-dim); font-size: 1.1rem; max-width: 700px; margin: 0 auto;">Our auto
                    transport service handles all types of four-wheelers with equal care.</p>
            </div>
        ...
        <div class="container">
            <div style="text-align: center; margin-bottom: 60px;">
                ...
                <p style="color: var(--color-text-dim); font-size: 1.1rem; max-width: 800px; margin: 0 auto;">Our car
                    shipping service operates across all major metro cities and towns throughout India.</p>
            </div>
        ...
        <div class="container">
            <div style="text-align: center; margin-bottom: 60px;">
                ...
                <p style="color: var(--color-text-dim); font-size: 1.1rem; max-width: 700px; margin: 0 auto;">Your
                    vehicle's safety is our top priority with comprehensive protection.</p>
            </div>
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 30px;">
                ...
                <div class="glass-card floating" style="padding: 35px; text-align: center; animation-delay: 1s;">
                    ...
                    <p style="color: var(--color-text-dim); line-height: 1.6;">Specialized car carriers (single and
                        shared)
                        for safe transport.</p>
                </div>
        ...
        <div class="container" style="position: relative; z-index: 1;">
            <div style="text-align: center; margin-bottom: 60px;">
                ...
                <p style="color: var(--color-text-dim); font-size: 1.1rem; max-width: 600px; margin: 0 auto;">Common
                    questions about our car transport services.</p>
            </div>
            ...
            <div class="faq-grid">
                ...
                <div class="glass-card faq-card">
                    <h4 style="margin-bottom: 10px; display: flex; align-items: start; gap: 10px;">
                        ...
                        What is the cost of car shifting in India?
                    </h4>
                    <p style="color: var(--color-text-dim); line-height: 1.6; padding-left: 35px;">
                        The cost depends on the car type, distance, and carrier type (open vs. enclosed). Contact us for
                ...
                <div class="glass-card faq-card">
                    ...
                    <p style="color: var(--color-text-dim); line-height: 1.6; padding-left: 35px;">
                        Delivery typically takes 3-7 days depending on the distance and route. We provide estimated
    ...
    <!-- State-wise Bike Transport Section (Kept as is or removed if less relevant, but generally good for interlinking, I'll keep it but maybe update title later if user asks. For now replicating bike page structure strictly) -->
    <section style="padding: 80px 0; background: rgba(255,255,255,0.02); position: relative;">
        <div class="container">
            <div style="text-align: center; margin-bottom: 60px;">
                ...
                <p style="color: var(--color-text-dim); font-size: 1.1rem; max-width: 700px; margin: 0 auto;">We provide
                    car transport services across all states in India.</p>
            </div>
            <!-- Using the same state list but visually, maybe I should just keep the bike one for cross-linking? Or generate car links? 
                 Since I don't have car-specific state pages yet, I will keep the structure but change text to "Car transport in..." 
                 However, linking to bike pages would be wrong. 
                 I'll assume for now I should just list them as text or keep the section generic. 
                 Actually, the user asked to create A PAGE like bike-transport-service.html. 
                 Updating ~30 links to non-existent pages is bad.
                 I will link to # for now or just keep it as a list. -->
